...
from docbot import settings
from docbot.manager import PluginsManager
from docbot.slackclient import SlackClient
from docbot.dispatcher import MessageDispatcher
